...
void main() async {
  ...
  // Seed demo users and sync flags (run once, don't block startup)
  try {
    await SeedData.seedDemoUsers().timeout(const Duration(seconds: 5));
    await SeedData.syncUsersFromPreRegistered().timeout(const Duration(seconds: 5));
  } catch (_) {}
